...
// --- UI contract: moves exposed for Konva / sidebar ---
{
  ...
  assert(typeof moves(GAME_PHASES.UNIT_PLACEMENT).selectTarget === 'function', 'UI: selectTarget');
}
...
// --- shared moves: selectTarget + highlight ---
{
  const G = makeG();
  ...
  moves.selectTarget(playCtx(G, ctx, events), { fighterId: 'hero1' });
